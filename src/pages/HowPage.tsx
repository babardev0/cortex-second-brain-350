  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          <div ref={heroRef} className="relative w-full max-w-3xl mx-auto">
            ...
            <div className="glass-panel rounded-full py-5 px-8 inline-block mx-auto mb-12">
              <h1 className="text-2xl md:text-3xl font-bold text-primary">How does FubhX work?</h1>
            </div>
            
            <p className="text-xl text-center text-foreground/80 max-w-2xl mx-auto mb-12">
              There's a lot of magic and sophisticated technology behind FubhX, but we've kept it simple to use.
            </p>
        ...
        {/* Workflow Section */}
        <div className="mb-24">
          <h2 className="text-3xl font-bold text-center mb-12">The FubhX Workflow</h2>
          ...
          <div className="relative">
            ...
            <div className="space-y-16 pl-4">
              ...
              <WorkflowStep 
                number={2}
                title="Organize"
                description="FubhX automatically categorizes and tags your content using advanced AI, creating a beautiful, organized knowledge base without manual effort."
              />
              <WorkflowStep 
                number={3}
                title="Connect"
        ...
        <div className="mb-24">
          ...
          <FeatureShowcase
            ...
            description="FubhX transforms your notes and saved content into a beautiful, visual interface that makes browsing your digital mind a pleasure."
          ...
          <FeatureShowcase
            ...
            description="Unlike social bookmarking tools, FubhX is completely private. Your data remains yours alone, secured with end-to-end encryption."
            image="/placeholder.svg"
            features={[
          ...
          <FeatureShowcase
            ...
            description="FubhX becomes an extension of your thinking process, available across all your devices and integrated with your workflow."
            image="/placeholder.svg"
            features={[
        ...
        <div className="py-16 px-4 rounded-lg glass-panel my-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ValueProp
              ...
              description="FubhX helps you stay focused by eliminating distractions and streamlining your thinking process."
            />
            <ValueProp
